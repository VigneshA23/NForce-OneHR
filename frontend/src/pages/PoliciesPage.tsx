...
import { Plus, Megaphone, CheckCircle, Clock, Search, MoreVertical } from 'lucide-react';
    ...
    <div ref={ref} style={{ position: 'relative', display: 'inline-block' }}>
      ...
      {open && (
        <>
          ...
          <div style={{ position: 'absolute', right: 0, top: '110%', background: 'var(--panel)', border: '1px solid var(--line)', borderRadius: 8, boxShadow: '0 12px 32px rgba(0,0,0,.45)', zIndex: 99, minWidth: 160, overflow: 'hidden' }}>
            {items.map((item, i) => (
