...
-- Numbered V125 (not V124) because origin/dev already has V124__add_wfh_day_fraction.sql —
-- see V40/V47 header comments before assuming a version number is free on the shared dev DB.
--
